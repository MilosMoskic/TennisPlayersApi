    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteSponsors", x => new { x.AthleteId, x.SponsorId });
                    table.ForeignKey(
                        name: "FK_AthleteSponsors_Athletes_AthleteId",
                        column: x => x.AthleteId,
                        principalTable: "Athletes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AthleteSponsors_Sponsors_SponsorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteTournaments", x => new { x.AthleteId, x.TournamentId });
                    table.ForeignKey(
                        name: "FK_AthleteTournaments_Athletes_AthleteId",
                        column: x => x.AthleteId,
                        principalTable: "Athletes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AthleteTournaments_Tournaments_TournamentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteSponsors_SponsorId",
                table: "AthleteSponsors",
                column: "SponsorId");

            migrationBuilder.CreateIndex(
                name: "IX_AthleteTournaments_TournamentId",
                table: "AthleteTournaments",
                column: "TournamentId");
